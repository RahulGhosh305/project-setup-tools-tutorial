...
function App() {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_URL_VERSION}/posts`)
      ...
      <div>
        ...
        <p className="read-the-docs mt-2">
          ...
          <span className="font-bold">
            Prefix {import.meta.env.VITE_URL_VERSION}
          </span>{" "}
      ...
      <div>
        <p>
          ...
          <span className="font-bold underline">
            {import.meta.env.VITE_URL_VERSION === "api1"
        ...
        <p>
          ...
          <span className="font-bold underline">
            /{import.meta.env.VITE_URL_VERSION}/posts
          </span>
        </p>
      </div>
      <div>
